...
if (! function_exists('days_this_month')) {
    ...
    {
        return days_in_month(\Carbon\Carbon::now()->month, \Carbon\Carbon::now()->year);
    }
}
...
if (! function_exists('days_next_month')) {
    ...
    {
        return days_in_month(\Carbon\Carbon::now()->addMonth()->month, \Carbon\Carbon::now()->addMonth()->year);
    }
}
...
if (! function_exists('days_left_in_month')) {
    ...
    {
        return days_this_month() - \Carbon\Carbon::now()->day;
    }
}
...
if (! function_exists('days_left_in_year')) {
    ...
    {
        return days_this_year() - \Carbon\Carbon::now()->dayOfYear;
    }
}
